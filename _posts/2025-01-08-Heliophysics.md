...
External ip = [205.154.246.79 - whatismyipaddress.cOm](https://whatismyipaddress.com/ip/205.154.246.79)
...
Hinode explores the magnetic fields of the Sun to improve understanding of what powers the solar atmosphere and drives solar eruptions. Hinode’s Solar Optical Telescope is the first space-borne instrument to measure the strength and direction of the Sun’s magnetic field on the Sun’s surface, the photosphere.  [missionWebfront](https://science.nasa.gov/mission/hinode/) : [images](https://science.nasa.gov/gallery/hinode-images/) @la-county-isd Karen Bass HollyJMitchell HildaSolis JAnice HAhn, I found another heliophysics mission @nasa-jpl @nasa-pds, it popped up in the [NearSpaceNEtwork_MonitoringTool SCAN](https://scan-now.gsfc.nasa.gov/scan) @blackgirlscode thethings that pop up in the monitoring tools are good things to use as ideas for managing a [databese](https://www.postgresql.org/docs/current/tutorial.html)... [safe content](https://ethicspress.com/products/ethical-computing) 

![hinode](https://science.nasa.gov/wp-content/uploads/2016/05/hinode-mashup.gif)
...
JPL/DASTCOM            Small-body Index Search Results     2026-Jan-13 10:36:38
 ...
 Matching small-bodies: 
    No matches found.
*******************************************************************************
 Select ... [F]tp, [M]ail, [R]edisplay, ?, <cr>: hi
*******************************************************************************
...
*******************************************************************************
 Select ... [F]tp, [M]ail, [R]edisplay, ?, <cr>: -235
*******************************************************************************
